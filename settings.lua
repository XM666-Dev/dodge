...
mod_settings =
{
    ...
    {
        id = "input_duration",
        ui_name = "Input duration",
        ui_description = "Duration of the input buffer for the dodge key.",
        value_default = 10,
        scope = MOD_SETTING_SCOPE_RUNTIME,
        ui_fn = mod_setting_text_integer,
    },
    {
        id = "cooldown_duration",
        ui_name = "Cooldown duration",
        ui_description = "Cooldown frames after performing a dodge.",
        value_default = 20,
        scope = MOD_SETTING_SCOPE_RUNTIME,
        ui_fn = mod_setting_text_integer,
    },
    {
        id = "ready_duration",
        ui_name = "Ready duration",
        ui_description = "Preparation frames before a dodge.",
        value_default = 0,
        scope = MOD_SETTING_SCOPE_RUNTIME,
        ui_fn = mod_setting_text_integer,
    },
    {
        id = "dodge_duration",
        ui_name = "Dodge duration",
        ui_description = "Duration of a dodge.",
        value_default = 30,
        scope = MOD_SETTING_SCOPE_RUNTIME,
        ui_fn = mod_setting_text_integer,
    },
    {
        id = "dodge_multiplier",
        ui_name = "Dodge multiplier",
        ui_description = "Multiplies the maximum number of dodges available.",
        value_default = 1,
        scope = MOD_SETTING_SCOPE_RUNTIME,
    ...
    },
    {
        id = "friction",
        ui_name = "Friction",
        ui_description = "Friction applied when grabbing walls.",
        value_default = 8,
        scope = MOD_SETTING_SCOPE_RUNTIME,
        ui_fn = mod_setting_text_number,
    },
    {
        id = "x_speed",
        ui_name = "X speed",
        ui_description = "Dodge speed along the x-axis.",
        value_default = 250,
        scope = MOD_SETTING_SCOPE_RUNTIME,
        ui_fn = mod_setting_text_number,
    },
    {
        id = "y_speed",
        ui_name = "Y speed",
        ui_description = "Dodge speed along the y-axis.",
        value_default = 250,
        scope = MOD_SETTING_SCOPE_RUNTIME,
        ui_fn = mod_setting_text_number,
    },
